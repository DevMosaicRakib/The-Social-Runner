...
import { User, Camera, Mail, Lock, MapPin, Calendar, FileText, Eye, EyeOff, User as UserIcon, ArrowLeft, Home, Trophy, Clock } from "lucide-react";
...
export default function Profile() {
  ...
  // Fetch user events to display past events
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 pb-20 md:pb-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <Link href="/">
              <Button variant="outline" className="flex items-center gap-2 w-fit" size="sm">
        ...
        <Tabs defaultValue="personal" className="space-y-6">
          <TabsList className="grid w-full grid-cols-2 md:grid-cols-5 gap-1 md:gap-0">
            ...
            <TabsTrigger value="bio" className="text-xs md:text-sm">Bio & Photo</TabsTrigger>
            <TabsTrigger value="progress" className="text-xs md:text-sm">Progress</TabsTrigger>
            <TabsTrigger value="calendar" className="text-xs md:text-sm">Events</TabsTrigger>
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Events you're attending or have shown interest in
                  </CardDescription>
                </CardHeader>
                <CardContent>
                          ...
                          <div className="flex justify-between items-start mb-2">
                            ...
                            <div className="flex items-center gap-2">
                              {event.userAttendanceStatus === 'attending' && (
                                <span className="bg-green-100 text-green-800 text-xs px-2 py-1 rounded-full">Attending</span>
                              )}
                              {event.userAttendanceStatus === 'maybe' && (
                                <span className="bg-yellow-100 text-yellow-800 text-xs px-2 py-1 rounded-full">Maybe</span>
                              )}
                            </div>
                          </div>
              ...
              <Card>
                ...
                <CardContent>
                  {userEvents.filter(event => {
                    const eventDateTime = new Date(`${event.date}T${event.time}`);
                    return eventDateTime <= new Date() && event.userAttendanceStatus === 'attending';
                  }).length > 0 ? (
                    <div className="space-y-4">
                      {userEvents.filter(event => {
                        const eventDateTime = new Date(`${event.date}T${event.time}`);
                        ...
                        <div key={event.id} className="border rounded-lg p-4 bg-gray-50 opacity-75">
                          <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="text-center py-8 text-gray-500">
                      ...
                      <p className="text-sm">Complete some events to build your running history!</p>
                    </div>
                  )}
                </CardContent>
              </Card>
